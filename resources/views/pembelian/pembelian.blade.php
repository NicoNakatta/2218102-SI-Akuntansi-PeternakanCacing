                  ...
                  <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                              <form class="forms-sample" method="post" action="{{route('create_pembelian')}}">
                              @csrf
                      ...
                      <div class="form-group">
                        ...
                        <select name="barang" class="form-select" id="kode_pembelian">
                      ...
                      <div class="form-group">
                        <label for="kode_satuan">Supplier</label>
                        <select name="supplier" class="form-select" id="kode_pembelian">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabel Data Pembelian </p>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$pembelian->barang->nm_barang}}</td>
                            <td>{{$pembelian->barang->harga}}</td>
                            <td>{{$pembelian->supplier->nama_supplier}}</td>
                            <td>{{$pembelian->quantity}}</td>
                            <td>{{$pembelian->total_harga}}</td>
                            <td>{{$pembelian->tgl_pembelian}}</td>
                            <td><a href="{{ url('/edit_pembelian/'.$pembelian->kode_po) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$pembelian->kode_po}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$pembelian->kode_po}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$pembelian->barang->nm_barang}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_pembelian',['kode_po'=> $pembelian->kode_po])}}">
                                  @csrf
                                  @method('DELETE')
