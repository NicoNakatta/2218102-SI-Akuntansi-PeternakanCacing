              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_supplier/'.$supplier->kode_supplier) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$supplier->kode_supplier}}" class="fcontrol" id="kode_supplier" placeholder="Kode">
                                  <div class="form-group">
                                    <label for="nm_barang">Nama supplier</label>
                                    <input type="text" name="nama" value="{{$supplier->nama_supplier}}" class="form-control" id="nama_supplier" placeholder="supplier">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Alamat</label>
                                    <input type="text" name="alamat" value="{{$supplier->alamat}}" class="form-control" id="nama_supplier" placeholder="supplier">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Kota</label>
                                    <input type="text" name="kota" value="{{$supplier->kota}}" class="form-control" id="nama_supplier" placeholder="supplier">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">No_telp</label>
                                    <input type="text" name="no_telp" value="{{$supplier->no_telp}}" class="form-control" id="nama_supplier" placeholder="supplier">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Email</label>
                                    <input type="text" name="email" value="{{$supplier->email}}" class="form-control" id="nama_supplier" placeholder="supplier">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Contact Person</label>
                                    <input type="text" name="contact_person" value="{{$supplier->contact_person}}" class="form-control" id="nama_supplier" placeholder="supplier">
                                  </div>
