                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                              <form class="forms-sample" method="post" action="{{route('create_karyawan')}}">
                                @csrf
                      <div class="form-group">
                        <label for="nm_barang">Nama Karyawan</label>
                        <input type="text" name="nama" class="form-control" id="nama_karyawan" placeholder="Karyawan">
                      </div>
                      <div class="form-group">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabel Data Karyawan </p>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$karyawan->hak_akses}}</td>
                            <td><a href="{{ url('/edit_karyawan/'.$karyawan->id_karyawan) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$karyawan->id_karyawan}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$karyawan->id_karyawan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$karyawan->nama_karyawan}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_karyawan',['id_karyawan'=> $karyawan->id_karyawan])}}">
                                  @csrf
                                  @method('DELETE')
