              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_karyawan/'.$karyawan->id_karyawan) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$karyawan->id_karyawan}}" class="fcontrol" id="kode_karyawan" placeholder="Kode">
                                  <div class="form-group">
                                    <label for="nm_barang">Nama karyawan</label>
                                    <input type="text" name="nama" value="{{$karyawan->nama_karyawan}}" class="form-control" id="nama_karyawan" placeholder="karyawan">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">hak Akses</label>
                                    <input type="text" name="hak_akses" value="{{$karyawan->hak_akses}}" class="form-control" id="nama_karyawan" placeholder="karyawan">
                                  </div>
