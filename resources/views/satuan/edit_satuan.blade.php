              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_satuan/'.$satuan->kode_satuan) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$satuan->kode_satuan}}" class="fcontrol" id="kode_satuan" placeholder="Kode">
                                  <div class="form-group">
                                    <label for="nm_barang">Nama Satuan</label>
                                    <input type="text" name="nama" value="{{$satuan->nama_satuan}}" class="form-control" id="nama_satuan" placeholder="Satuan">
                                  </div>
