                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{route('create_satuan')}}">
                                  @csrf
                                  <div class="form-group">
                                    <label for="kd_barang">Kode Satuan</label>
                                    <input type="text" name="kode" class="form-control" id="kode_satuan" placeholder="Kode">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Nama Satuan</label>
                                    <input type="text" name="nama" class="form-control" id="nama_satuan" placeholder="Satuan">
                                  </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabel Satuan </p>
                      ...
                      <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{ url('/edit_satuan/'.$satuan->kode_satuan) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$satuan->kode_satuan}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$satuan->kode_satuan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$satuan->nama_satuan}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_satuan',['kode_satuan'=> $satuan->kode_satuan])}}">
                                  @csrf
                                  @method('DELETE')
