                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Input penjualan</h5>
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                              <form class="forms-sample" method="post" action="{{route('create_penjualan')}}">
                              @csrf
                      <div class="form-group" >
                        <label for="kode_satuan">Karyawan</label>
                        <select name="karyawan" class="form-select" id="j_barang">
                      ...
                      <div class="form-group">
                        <label for="kode_satuan">Barang</label>
                        <select name="barang" class="form-select" id="kode_penjualan">
                          @foreach ($barang as $barang)
                            <option value="{{$barang->kode_barang}}" >{{$barang->nm_barang}} = {{$barang->harga}}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="kode_satuan">customer</label>
                        <select name="customer" class="form-select" id="kode_penjualan">
                      ...
                      <div class="form-group">
                        <label for="kode_satuan">outlet</label>
                        <select name="outlet" class="form-select" id="kode_penjualan">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="quantity" class="form-control" id="total" placeholder="Total">
                      </div>
                      <div class="form-group">
                  ...
                  <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$penjualan->karyawan->nama_karyawan}}</td>
                            <td>{{$penjualan->barang->nm_barang}}</td>
                            ...
                            <td><a href="{{ url('/edit_penjualan/'.$penjualan->id_transaksi) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$penjualan->id_transaksi}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$penjualan->id_transaksi}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$penjualan->barang->nm_barang}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_penjualan',['id_transaksi'=> $penjualan->id_transaksi])}}">
                                  @csrf
                                  @method('DELETE')
