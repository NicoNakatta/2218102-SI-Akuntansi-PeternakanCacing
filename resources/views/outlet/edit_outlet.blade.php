              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_outlet/'.$outlet->kode_outlet) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$outlet->kode_outlet}}" class="fcontrol" id="kode_outlet" placeholder="Kode">
                                  <div class="form-group">
                                    <label for="nm_barang">Nama outlet</label>
                                    <input type="text" name="nama" value="{{$outlet->nama_outlet}}" class="form-control" id="nama_outlet" placeholder="outlet">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Alamat</label>
                                    <input type="text" name="alamat" value="{{$outlet->alamat}}" class="form-control" id="nama_outlet" placeholder="outlet">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Kota</label>
                                    <input type="text" name="kota" value="{{$outlet->kota}}" class="form-control" id="nama_outlet" placeholder="outlet">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">No_telp</label>
                                    <input type="text" name="no_telp" value="{{$outlet->no_telp}}" class="form-control" id="nama_outlet" placeholder="outlet">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Email</label>
                                    <input type="text" name="email" value="{{$outlet->email}}" class="form-control" id="nama_outlet" placeholder="outlet">
                                  </div>
