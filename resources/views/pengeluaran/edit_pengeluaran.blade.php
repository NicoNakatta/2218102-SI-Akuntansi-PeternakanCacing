              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_pengeluaran/'.$pengeluaran->kode_pengeluaran) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$pengeluaran->kode_pengeluaran}}" class="fcontrol" id="kode_pengeluaran" placeholder="Kode">
                                  <div class="form-group">
                                    <label for="nm_barang">Biaya Listrik</label>
                                    <input type="text" name="listrik" value="{{$pengeluaran->biaya_listrik}}" class="form-control" id="nama_pengeluaran" placeholder="pengeluaran">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Biaya</label>
                                    <input type="text" name="air" value="{{$pengeluaran->biaya_air}}" class="form-control" id="nama_pengeluaran" placeholder="pengeluaran">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Biaya</label>
                                    <input type="text" name="tanah" value="{{$pengeluaran->biaya_sewa_tanah}}" class="form-control" id="nama_pengeluaran" placeholder="pengeluaran">
                                  </div>
