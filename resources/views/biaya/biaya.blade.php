                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                              <form class="forms-sample" method="post" action="{{route('create_biaya')}}">
                              @csrf
                      <div class="form-group">
                        <label for="nm_barang">Total Gaji Pegawai</label>
                        <input type="text" class="form-control" name="gaji" placeholder="Gaji">
                      </div>
                      <div class="form-group">
                        <label for="kd_barang">Harga Bibit</label>
                        <input type="text" class="form-control" name="bibit" placeholder="Harga Bibit">
                      </div>
                      <div class="form-group">
                        <label for="nm_barang">Harga Obat</label>
                        <input type="text" class="form-control" name="obat" placeholder="Harga Obat">
                      </div>
                      <div class="form-group">
                        <label for="kd_barang">Harga Tanah</label>
                        <input type="text" class="form-control" name="tanah" placeholder="Harga Tanah">
                      </div>
                      <div class="form-group">
                        <label for="nm_barang">Harga Pakan</label>
                        <input type="text" class="form-control" name="pakan" placeholder="Harga Pakan">
                      </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabel Data Biaya </p>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$biaya->total_gaji_pegawai}}</td>
                            <td>{{$biaya->harga_bibit}}</td>
                            <td>{{$biaya->harga_obat}}</td>
                            <td>{{$biaya->harga_tanah}}</td>
                            <td>{{$biaya->harga_pakan}}</td>
                            <td><a href="{{ url('/edit_biaya/'.$biaya->kode_biaya) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$biaya->kode_biaya}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$biaya->kode_biaya}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$biaya->kode_biaya}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_biaya',['kode_biaya'=> $biaya->kode_biaya])}}">
                                  @csrf
                                  @method('DELETE')
