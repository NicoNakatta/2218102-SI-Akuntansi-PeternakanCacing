              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_biaya/'.$biaya->kode_biaya) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$biaya->kode_biaya}}" class="fcontrol" id="kode_biaya" placeholder="Kode">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Total Gaji</label>
                                    <input type="text" name="gaji" value="{{$biaya->total_gaji_pegawai}}" class="form-control" id="nama_biaya" placeholder="gaji">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Harga Bibit</label>
                                    <input type="text" name="bibit" value="{{$biaya->harga_bibit}}" class="form-control" id="nama_biaya" placeholder="bibit">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Harga Obat</label>
                                    <input type="text" name="obat" value="{{$biaya->harga_obat}}" class="form-control" id="nama_biaya" placeholder="obat">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Harga Tanah</label>
                                    <input type="text" name="tanah" value="{{$biaya->harga_tanah}}" class="form-control" id="nama_biaya" placeholder="tanah">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Harga Pakan</label>
                                    <input type="text" name="pakan" value="{{$biaya->harga_pakan}}" class="form-control" id="nama_biaya" placeholder="pakan">
                                  </div>
