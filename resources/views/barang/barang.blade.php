          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('cetak_barang')}}" class="btn btn-warning">CETAK LAPORAN</a></li>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                              <form class="forms-sample" method="post" action="{{route('create_barang')}}">
                                @csrf
                                <div class="form-group">
                                  <label for="kd_barang">Kode Barang</label>
                                  <input type="text" name="kode" class="form-control" id="kd_barang" placeholder="Kode">
                                </div>
                                <div class="form-group">
                                  <label for="nm_barang">Nama Barang</label>
                                  <input type="text" name="nama" class="form-control" id="nm_barang" placeholder="Barang">
                                </div>
                                <div class="form-group">
                                  <label for="kode_barang">Jenis Satuan</label>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabel Data Barang </p>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$barang->harga}}</td>
                            <td><a href="{{ url('/edit_barang/'.$barang->kode_barang) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$barang->kode_barang}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$barang->kode_barang}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$barang->nama_barang}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_barang',['kode_barang'=> $barang->kode_barang])}}">
                                  @csrf
                                  @method('DELETE')
