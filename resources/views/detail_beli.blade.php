          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><button class="btn btn-info">CETAK LAPORAN</button></li>
                  <li class="breadcrumb-item"><button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#defaultModal">BUAT LAPORAN</button></li>
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{route('create_detail_beli')}}">
                                  @csrf
                                  <div class="form-group" >
                                    <label for="kode_satuan">Pembelian</label>
                                    <select name="kode" class="form-select" id="j_barang">
                                      @foreach ($po as $po)
                                        <option value="{{$po->id_po}}" >{{$po->tgl_pembelian}}</option>
                                      @endforeach
                                    </select>
                                  </div>
            ...
            <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">DATA DETAIL PEMBELIAN</h4>
                    <p class="card-description"> Tabel Detail Pembelian </p>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{$pembelian->kode_po}}</td>
                            <td>{{$pembelian->kode_outlet}}</td>
                            <td>{{$pembelian->kode_barang}}</td>
                            <td>{{$pembelian->kode_customer}}</td>
                          </tr>
                          @endforeach
                        </tbody>
                      </table>
