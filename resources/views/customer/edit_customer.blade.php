              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="card">
                              <div class="card-body">
                                <form class="forms-sample" method="post" action="{{ url('/update_customer/'.$customer->kode_customer) }}">
                                @csrf
                                @method('PUT')
                                  <div class="form-group">
                                    <input type="hidden" name="kode" value="{{$customer->kode_customer}}" class="fcontrol" id="kode_customer" placeholder="Kode">
                                  <div class="form-group">
                                    <label for="nm_barang">Nama customer</label>
                                    <input type="text" name="nama" value="{{$customer->nama_customer}}" class="form-control" id="nama_customer" placeholder="customer">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Alamat</label>
                                    <input type="text" name="alamat" value="{{$customer->alamat}}" class="form-control" id="nama_customer" placeholder="customer">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Kota</label>
                                    <input type="text" name="kota" value="{{$customer->kota}}" class="form-control" id="nama_customer" placeholder="customer">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">No_telp</label>
                                    <input type="text" name="no_telp" value="{{$customer->no_telp}}" class="form-control" id="nama_customer" placeholder="customer">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Email</label>
                                    <input type="text" name="email" value="{{$customer->email}}" class="form-control" id="nama_customer" placeholder="customer">
                                  </div>
                                  <div class="form-group">
                                    <label for="nm_barang">Contact Person</label>
                                    <input type="text" name="contact_person" value="{{$customer->contact_person}}" class="form-control" id="nama_customer" placeholder="customer">
                                  </div>
