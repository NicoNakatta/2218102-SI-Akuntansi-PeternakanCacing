                ...
                <ol class="breadcrumb">
                  ...
                  <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                              <div class="card-body">
                              <form class="forms-sample" method="post" action="{{route('create_customer')}}">
                              @csrf
                              <div class="form-group">
                        <label for="nm_barang">Nama Customer</label>
                        <input type="text" name="nama" class="form-control" id="nm_customer" placeholder="Customer">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="kd_barang">Kota</label>
                        <input type="text" name="kota" class="form-control" id="kota" placeholder="Kota">
                      </div>
                      <div class="form-group">
                        <label for="nm_barang">No Telephone</label>
                        <input type="number" name="no_telp" class="form-control" id="no_telp" placeholder="Nomor Telephone">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="harga">Contact Person</label>
                        <input type="text" name="contact_person" class="form-control" id="contact" placeholder="Contact Person">
                      </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabel Data Customer </p>
                    <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="{{ url('/edit_customer/'.$customer->kode_customer) }}" class="btn btn-primary" id="edit" style="margin : 3px"><i class="fa fa-pencil"></i></a> |
                                <a data-bs-toggle="modal" data-bs-target="#deleteModal{{$customer->kode_customer}}"
                                href="" class="btn btn-danger" id="hapus" style="margin : 3px"><i class="fa fa-trash"></1></a></td>
                          </tr>
                          <div class="modal fade" id="deleteModal{{$customer->kode_customer}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                  <p>Apakah Anda Yakin Ingin Menghapus {{$customer->nama_customer}}?</p>
                                </div>
                                <div class="modal-footer">
                                <form class="forms-sample" method="post" action="{{route('delete_customer',['kode_customer'=> $customer->kode_customer])}}">
                                  @csrf
                                  @method('DELETE')
